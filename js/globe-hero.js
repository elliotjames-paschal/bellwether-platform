...
// Globe
// ============================================
function initHeroGlobe(containerId, options) {
    options = options || {};
    ...
    Promise.all([
        ...
        if (marketData.markets) {
            ...
            // Filter to only electoral markets for hero globe
        ...
        console.log('Hero globe loaded', allMarkets.length, 'electoral market points');
        animate();
...
// ============================================
// Auto-initialize on page load (Hero globe only)
// ============================================
document.addEventListener('DOMContentLoaded', function() {
    if (document.getElementById('hero-globe-container')) {
        initHeroGlobe('hero-globe-container', { size: 640, rotationSpeed: 0.08 });
    }
});
